...
class RAGChatbot:
    ...
    def setup_chain(self):
        ...
        try:
            ...
            # Get the API key from environment (.env file)
...
def main():
    ...
    with st.sidebar:
        ...
        # Status display only — keys themselves live in .env, not typed here
        st.text_input(
            "Google API Key (Gemini):",
            value=google_api_key or "",
            type="password",
            help="Add GOOGLE_API_KEY to your .env file",
            disabled=True
        )
        ...
        st.text_input(
            ...
            value=elevenlabs_api_key or "",
            type="password",
            help="Add ELEVENLABS_API_KEY to your .env file",
            disabled=True
        )
        ...
        *📋 Setup:*
        1. Add your keys to a .env file (see below)
    ...
    # Check API keys
    if not google_api_key:
        st.error("Please add GOOGLE_API_KEY to your .env file for RAG functionality.")
    
    if not groq_api_key:
        st.error("Please add GROQ_API_KEY to your .env file for vision analysis.")
